/* Generated By:JJTree&JavaCC: Do not edit this line. HexLang.java */
package parser;
public class HexLang/*@bgen(jjtree)*/implements HexLangTreeConstants, HexLangConstants {/*@bgen(jjtree)*/
  protected JJTHexLangState jjtree = new JJTHexLangState();
...
//
 ...
 jjtree.openNodeScope(jjtn000);Token t;
  ...
  public HexLangTokenManager token_source;
  ...
  public HexLang(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public HexLang(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new HexLangTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public HexLang(java.io.Reader stream) {
  ...
  public HexLang(HexLangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(HexLangTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
